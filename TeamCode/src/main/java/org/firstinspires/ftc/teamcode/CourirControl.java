...
//    public static double turnP = -0.25;
//
//    public static double strafeComp = 1.5;
//
...
//        double denominator = Math.max(rDrive, Math.max(rStrafe, turn));
//
//        double frontLeftPower = (rDrive + rStrafe * strafeComp + turn);
//        double frontRightPower = (rDrive - rStrafe * strafeComp - turn);
//        double rearLeftPower = (rDrive - rStrafe * strafeComp + turn);
//        double rearRightPower = (rDrive + rStrafe * strafeComp - turn);
//
...
//
//        telemetry.addData("forward P", drivePower);
//        telemetry.addData("strafe P", strafePower);
//
...
//        double headingError = Math.abs(tHeading - cHeading);
//        boolean isHeadingOnPose = headingError <= ANGULAR_TOLARENCE;
...
//            comment = "determine if you are at a pose",
//            tooltip = "determine if you are at a pose",
//            parameterLabels = {"targetPose2D", "currentPose2D", "positionalTolerance", "angularTolerance"}
//    )
//    public static boolean isNotAround(Pose2D targetPose, Pose2D currentPose, double positionalTolerance, double angularTolerance) {
//        double tX = targetPose.getX(DistanceUnit.INCH);
//        double cX = currentPose.getX(DistanceUnit.INCH);
//        telemetry.addData("errorX", Math.abs(tX - cX));
//        boolean isDriveOnPose = Math.abs(tX - cX) <= positionalTolerance;
//
//        double tY = targetPose.getY(DistanceUnit.INCH);
//        double cY = currentPose.getY(DistanceUnit.INCH);
//        boolean isStrafeOnPose = Math.abs(tY - cY) <= positionalTolerance;
//
//
//        double tHeading = targetPose.getHeading(AngleUnit.DEGREES);
//        double cHeading = currentPose.getHeading(AngleUnit.DEGREES);
//        double headingError = Math.abs(tHeading - cHeading);
//        boolean isHeadingOnPose = headingError <= angularTolerance;
//        telemetry.addData("isDriveOnPOse", isDriveOnPose);
//        telemetry.addData("isStrafeOnPOse", isStrafeOnPose);
//        telemetry.addData("isHeadingOnPOse", isHeadingOnPose);
//
