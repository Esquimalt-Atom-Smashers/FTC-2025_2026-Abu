...
@Autonomous(name = "Blue Far Third Auto")
public class BlueFarThirdAuto extends LinearOpMode {
    @Override
    public void runOpMode() throws InterruptedException {
        ...
        AutoCommandInterpreter interpreter = new AutoCommandInterpreter(RobotPropertyParser.loadAuto(RobotPropertyParser.AUTO.BLUE_FAR_THIRD_AUTO));
        //Print auto title
