...
@Config
@TeleOp(name = "Kenny Blue deg adjust TeleOp", group = "AAA")
public class BlueDegAdjTeleOp extends LinearOpMode {
    ...
    RobotContainer.Alliance alliance = RobotContainer.Alliance.BLUE;
    double targetRpm;
