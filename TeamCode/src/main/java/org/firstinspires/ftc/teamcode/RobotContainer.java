...
public class RobotContainer extends BlocksOpModeCompanion {
    public static final Pose2d RED_RESET_POS = new Pose2d(60 - 11.5, 60 - 11, Math.toRadians(90));
    public static final Pose2d BLUE_RESET_POS = new Pose2d(60 - 11.5, -(60 - 11), Math.toRadians(270));
