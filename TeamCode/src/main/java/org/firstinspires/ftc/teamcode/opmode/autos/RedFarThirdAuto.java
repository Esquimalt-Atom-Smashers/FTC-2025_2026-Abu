...
@Autonomous(name = "Red Far Third Auto")
public class RedFarThirdAuto extends LinearOpMode {
    @Override
    public void runOpMode() throws InterruptedException {
        ...
        AutoCommandInterpreter interpreter = new AutoCommandInterpreter(RobotPropertyParser.loadAuto(RobotPropertyParser.AUTO.RED_FAR_THIRD_AUTO));
        //Print auto title
